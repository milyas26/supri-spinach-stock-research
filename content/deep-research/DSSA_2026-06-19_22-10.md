...
**Free float efektif: ~10,14%** — berdasarkan pemegang saham di bawah 1% (100% - 89,86% holders >1%). Kalau pakai data konsentrasi BEI, tingkat konsentrasi mencapai 95,76% per 31 Maret 2026 — artinya free float riil yang beredar di publik bisa cuma 4,24%. Apapun angkanya, ini sangat rendah dan menjadi akar masalah exclusion dari indeks global.
...
Free float DSSA cuma ~10,14% (atau bahkan 4,24% kalau pakai data konsentrasi BEI 95,76%). Ini yang bikin MSCI dan FTSE Russell DEPAK DSSA. Ironis: fundamental oke (revenue USD 2,79 miliar, Fortune 500), tapi struktur kepemilikan terlalu "tertutup" buat indeks global.
...
DSSA adalah paradoks — perusahaan dengan fundamental solid (Fortune 500, revenue USD 2,79 miliar, ekspansi digital agresif) tapi struktur kepemilikan yang jadi musuh terbesarnya sendiri. Free float ~10,14% (atau bahkan cuma 4,24% kalau pakai data konsentrasi BEI 95,76%) bikin saham ini "toxic" buat indeks global, dan efek dominonya brutal: MSCI + FTSE depak → passive fund jual paksa → harga crash 87% dalam 2 bulan.
