...
## 📊 6. SID Proxy — Active Brokers & Net Position

| Tanggal | Active Brokers | Net Buyers | Net Sellers | Seller Ratio |
|---|---|---|---|---|
| Jun 5 | 42 | 8 | 34 | **81%** |
| Jun 4 | 42 | 9 | 33 | **79%** |
| Jun 3 | 43 | 9 | 34 | **79%** |
...
**Interpretasi:**
- 🔴 **Sellers consistently 75-85% of active brokers** — ini sinyal distribusi berkepanjangan
- Active brokers relatif stabil di 42-49 range → belum ada capitulation massal retail
- Hanya 8-12 net buyers dari 35-49 brokers → mayoritas broker net sell
- BULLISH DIVERGENCE: meskipun sellers dominan, SM net buy +80K minggu ini → **SM mulai nyerap barang dari weak hands**

📎 Sumber: Data broker flow internal

---

## 🔥 7. Smart Money Flip Detection (14 Hari)
